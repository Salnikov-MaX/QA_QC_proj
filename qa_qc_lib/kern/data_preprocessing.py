...
dic = {
    "Эффективная проницаемость": "Porosity (open)",
    "Лабораторный номер": "Number",
       ...
       "Открытая пористость по газу": "PoroTBU",
       "Открытая пористость в пластовых условиях": "PoroTBU",
       "Открытая пористость по керосину": "Porosity (kerosine)",
       "Эффективная пористость": "Porosity (effective)",
       "Динамическая пористость": "PoroTBU",
       "Кпр_газ(гелий)": "PoroTBU",
       "Параметр пористости": "PoroTBU",
       "So": "PoroTBU",
       "Кво": "PoroTBU",
